...
function TreinosHub() {
  ...
  return (
    <div className="mx-auto max-w-6xl min-w-0 px-3 py-4 sm:px-6 sm:py-8">
      <header className="mb-5 flex items-start justify-between gap-3 sm:mb-8">
        <div className="flex items-start gap-3 min-w-0">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-2xl font-bold tracking-tight sm:text-3xl break-words">Treinos</h1>
        ...
        {TABS.map((t) => {
          ...
          return (
            <button
              ...
              className={`inline-flex flex-1 min-w-[100px] cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-lg px-3 sm:px-4 py-2 sm:py-2.5 min-h-[44px] text-xs sm:text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background ${
                isActive
