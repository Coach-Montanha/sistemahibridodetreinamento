...
import { SYSTEM_PROMPT, calcularDataFim, mensagemDeErroGateway, montarUserPrompt, normalizarPrescricao, } from "@/lib/prescricao-ia.server";
    ...
    if (isHibrido) {
        const templateFinal = data.hibrido.sessaoTemplate?.length > 0
            ...
            : continuation.lastSessionStructure
                ...
                : [];
        return normalizarPrescricaoHibrido(conteudo, templateFinal, await buscarCandidatosDoMolde(supabase, templateFinal));
    }
