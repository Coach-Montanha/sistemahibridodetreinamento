...
> = {
  ...
  a4_retrato: {
    nome: "A4 retrato",
    descricao: "2480×3508 — folha vertical para impressão",
    layout: {
      ...LAYOUT_PADRAO,
      largura: 2480,
      altura: 3508,
  ...
  quadrado: {
    nome: "Quadrado 1:1",
    descricao: "2160×2160 — post de feed",
    layout: {
      ...LAYOUT_PADRAO,
      largura: 2160,
      altura: 2160,
  ...
  retrato_3x4: {
    nome: "Retrato 3:4",
    descricao: "2160×2880 — vertical equilibrado",
    layout: {
      ...LAYOUT_PADRAO,
      largura: 2160,
      altura: 2880,
  ...
  story: {
    nome: "Story 9:16",
    descricao: "1440×2560 — tela cheia de stories",
    layout: {
      ...LAYOUT_PADRAO,
      largura: 1440,
      altura: 2560,
